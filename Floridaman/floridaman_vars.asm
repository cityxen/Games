...
.var var_player_dir      = $9fC1  // 0=stand 1=right 2=left 3=down 4=up
.var var_player_anim_fr  = $9fC2  // walk animation frame index 0-3
.var var_player_anim_tmr = $9fC3  // animation speed timer
